...
options = optimoptions('fmincon','Algorithm','active-set','Display','iter-detailed','FiniteDifferenceStepSize',2,'FunctionTolerance',5e-7,'StepTolerance',1e-7,'PlotFcns',@optimplotfval,'UseParallel',true);

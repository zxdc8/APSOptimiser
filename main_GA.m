...
options = optimoptions('ga','Display','iter','FunctionTolerance',1e-3,'PlotFcn',@gaplotbestf);


%Run Optimisation
[X,fval,exitflag,output,population,scores]=ga(objFun,7,[],[],[],[],LB,UB,@constraintsGA,options);   

...
% Design Parameters
Par.S                      = 125;    % Wing area [m^2]
Par.Range_req              = 1507;     % Required design range [nm]
Par.PLmax                  = 19000;     % Max payload [kg]
Par.MFC                    = 19000;     % Max Fuel capacity [kg]
Par.MTOM                   = 75000;     % Max Take Off Mass [kg]
Par.Airframe               = 41250;     % Operating Mass Empty [kg]
Par.PL_req                 = 15750;     % Design Payload [kg]  (34348lb)

% Engine parmetars
Par.EngFileName            = 'TF25Data'; % Aircraft type for engine data selection
Par.n                      = 2;         % Number of engines
Par.BPR                    = 10;       % By pass ratio
Par.TakeoffStaticThrust_lb = 25000;     % Take off thrust [lb]
...
Par.DragRise_Func          = 'DragRise_150C_twin2'; % Name of Drag Rise Funcitn, e.g.'DragRise_B777_AJenk';

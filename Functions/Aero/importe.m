function out1 = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   OUT1 = IMPORTFILE1(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   OUT1 = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   out1 = importfile1('out_1.txt', [19,21], [19,21]);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/03/18 15:48:12
...
out1 = (table2array(table(dataArray{1:end-1}, 'VariableNames', {'VarName7'})));
